...
public class TestDataGenerator {
    ...
    private static final String IMG_PATH = "D:\\Projects\\fullProjects\\IShop-full\\fillingDBForTesting\\src\\main\\resources\\img\\";
    private static final String MEDIA_PATH = "D:\\Projects\\fullProjects\\IShop-full\\src\\main\\webapp\\media\\";
    ...
    private static void insertProducts(Connection c, List<Category> categories, Map<String, Integer> categoryIdMap, Map<String, Integer> producerIdMap) throws SQLException, IOException {
        ...
        try (PreparedStatement ps = c.prepareStatement("insert into product values (?,?,?,?,?,?,?)")) {
            for (Product product : products) {
                ...
                ps.setInt(3, RANDOM.nextInt(300) * 10);
                ps.setString(4, generateProductDescription(product.category));
                ps.setString(5, product.imageLink);
